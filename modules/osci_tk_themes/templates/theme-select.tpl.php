...
<div id="system-themes-page">
	<h1>OSCI Themes</h1>
	<form role="form" name="OsciThemeForm" id="OsciThemeForm" action="admin/config/system/osci-themes/submit" method="POST">
						...
						<div class="theme-info">
							...
							<ul class="operations clearfix">
								<li class="0 first last">
									<a href="/admin/config/system/osci-themes/<?php echo $pub['vid']; ?>/settings">Settings</a>
								</li>
							</ul>
						</div>
					</div>
